...
--Loading the data.
CREATE EXTERNAL TABLE IF NOT EXISTS test (id INT, member_id INT, loan_amnt INT, loan_status STRING, purpose STRING, addr_state STRING, term STRING, int_rate STRING) ROW FORMAT SERDE 'org.apache.hadoop.hive.serde2.OpenCSVSerde' STORED AS TEXTFILE LOCATION 's3://lending-data-15210445/input/test/';
